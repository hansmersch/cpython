...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [BINARY_SLICE] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_SLICE] = { .nuops = 2, .uops = { { _RECORD_3OS_TYPE, OPARG_SIMPLE, 0 }, { _BINARY_SLICE, OPARG_SIMPLE, 0 } } },
